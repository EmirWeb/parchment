...
public class GridLayoutManagerTest {
    ...
    @Before
    public void setup() {
        attributes = new GridLayoutManagerAttributes(NUMBER_OF_COLUMNS, false, true, false, 0, SnapPosition.onScreenWithCellSpacing, CELL_SPACING, true, true, true, true, false, false, false);
